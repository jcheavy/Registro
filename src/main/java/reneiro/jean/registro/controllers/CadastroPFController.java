...
import reneiro.jean.registro.dtos.CadastroPFDto;
...
import reneiro.jean.registro.services.FuncionarioService;

@Controller
@RequestMapping("/cadastrarpf")
public class CadastroPFController {
	...
	/**
	 * Cadastra um funcionário pessoa física no sistema. by - jean
	 * 
	 * @param cadastroPFDto
	 * @param result
	...
	/**
	 * Converte os dados do DTO para funcionário. by - jean
	 * 
	 * @param cadastroPFDto
	 * @param result
	 * @return Funcionario
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result)
		...
		cadastroPFDto.getValoHora().ifPresent(valorHora -> funcionario.setValorHora(new BigDecimal(valorHora)));

		return funcionario;
	}

	/**
	 * Popula o DTO de cadastro com os dados do funcionário e empresa. by - jean
	 * 
	 * @param funcionario
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getValorHoraOpt()
				.ifPresent(valorHora -> cadastroPFDto.setValoHora(Optional.of(valorHora.toString())));
