...
import reneiro.jean.registro.dtos.LancamentoDto;
import reneiro.jean.registro.entities.Funcionario;
import reneiro.jean.registro.entities.Lancamento;
...
import reneiro.jean.registro.services.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		Page<Lancamento> lancamentos = this.lancamentoService.bucarFuncionarioId(funcionarioId, pageRequest);
	...
	private LancamentoDto converterLancamentoDto(Lancamento lancamento) {
	    ...
	    lancamentoDto.setData(formatter.format(lancamento.getData()));
...
//		lancamento.setData(this.dateFormat.parse(lancamentoDto.getData()));
		lancamento.setData(LocalDateTime.parse(lancamentoDto.getData(), this.formatter));
